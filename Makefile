...
#    Updated: 2023/10/05 12:06:04 by hleung           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
HEADERS		=	includes
DIR_SRCS	=	srcs/
LIST_SRCS	=	main.c parse_config.c parse_utils.c parse_elements.c free.c init.c check_map.c render.c get_structs_address.c event.c
