...
#    Updated: 2023/10/03 18:16:11 by tduprez          ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
HEADERS		=	includes
DIR_SRCS	=	srcs/
LIST_SRCS	=	main.c parse_config.c parse_utils.c parse_elements.c free.c init.c check_map.c raycasting.c get_structs_address.c event.c
